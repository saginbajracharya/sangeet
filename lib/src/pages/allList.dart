                  ...
                  return Container(
                    ...
                    child: ListTile(
                      ...
                      subtitle: _con.musics[index].artist != '<unknown>' 
                        ...
                        : Text(' '),
                      onTap: () {
                        _con.audioManagerInstance.start("file://${_con.musics[index].filePath}", _con.musics[index].title,
                          desc: _con.musics[index].displayName,
                          auto: true,
                          cover: _con.musics[index].albumArtwork).then((err) {
                          print(err);
                        });
                      }
                    ),
